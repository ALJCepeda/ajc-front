  ...
  <div class="app">
    <main class="mainNav border">
      ...
      <div class="nav-holder row-nw">
        ...
        <nav>
          <router-link to="/admin" :hidden="!isAuthenticated"
            >Admin</router-link
          >
          <router-link to="/home">Timeline</router-link>
          <router-link to="/about">About</router-link>
          <router-link to="/blogs"
            >Blog<!--<span class='subtitle-font'>71</span>--></router-link
          >
...
.cover-photo {
  ...
  h1 {
    ...
    .upToTablet({margin: 20px auto 0px;});
